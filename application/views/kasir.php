                    ...
                    <div class="col px-0">
                        <div class="row row-grid align-items-center">
                            ...
                            <div class="col-lg-6 pr-lg-5">
                                ...
                                <form action="<?= base_url() ?>kasir/main" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="email" class="form-control input-mask"  placeholder="example@domain.com" required>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-control-label text-white">Phone Number</label>
                                        <input type="text" name="telp" class="form-control input-mask" data-mask="0000 000 000" placeholder="0810 444 555" autocomplete="off" maxlength="12" required>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label class="form-control-label text-white">Alamat</label>
                                        <textarea type="text" name="alamat" class="form-control input-mask" placeholder="Alamat" required></textarea>
                                    </div>
        
                                    <div class="mt-5">
                                        <button type="submit" class="btn btn-outline-white my-2 float-right" >Mulai</button>
