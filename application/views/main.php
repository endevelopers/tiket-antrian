                    ...
                    <div class="col px-0">
                        <div class="row row-grid align-items-center">
                            <div class="col-lg-6 pr-lg-5">
                                ...
                                <h1 class="display-4 text-white mb-4">Mulai Untuk  <strong class="text-warning">Anda</strong></h1>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-sm mb-2 text-center">
                                            <a href="<?= base_url() ?>" class=" btn btn-sm d-none d-lg-inline-block btn-warning ml-auto ">Ambil Nomor Antrian</a>
